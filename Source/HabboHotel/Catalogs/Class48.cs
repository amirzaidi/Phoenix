...
namespace Phoenix.HabboHotel.Catalogs
{
	internal sealed class Class48
	{
		...
		internal ServerMessage GClass5_0
		{
			get
			{
		...
		{
			this.gclass5_0 = Phoenix.GetGame().GetCatalog().method_19(this);
		}
		...
		public void method_2(int int_4, ServerMessage gclass5_1)
		{
			gclass5_1.AppendInt32(this.int_2);
			gclass5_1.AppendInt32(this.int_3);
			gclass5_1.AppendInt32(this.int_0);
			gclass5_1.AppendStringWithBreak(this.string_0);
			gclass5_1.AppendInt32(Phoenix.GetGame().GetCatalog().method_4(int_4, this.int_0));
			gclass5_1.AppendBoolean(this.bool_0);
		}
	}
}
