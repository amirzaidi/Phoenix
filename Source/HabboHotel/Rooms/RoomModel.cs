...
namespace Phoenix.HabboHotel.Rooms
{
	internal sealed class RoomModel
	{
		...
		public ServerMessage method_1()
		{
			...
			ServerMessage gClass = new ServerMessage(31u);
			gClass.AppendStringWithBreak(stringBuilder.ToString());
			return gClass;
		}
		public ServerMessage method_2()
		{
			ServerMessage gClass = new ServerMessage(470u);
			...
			for (int i = 0; i < this.int_5; i++)
			{
				...
				gClass.AppendString(string.Concat(Convert.ToChar(13)));
			}
			return gClass;
		}
	}
