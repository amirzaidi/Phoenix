...
namespace Phoenix.Messages
{
	public sealed class ServerMessage
	{
		...
		public string Header
		{
			get
			{
				return Phoenix.GetDefaultEncoding().GetString(Base64Encoding.Encodeuint(this.MessageId, 2));
			}
		}
		public int Length
		{
		...
		{
			return this.Header + Phoenix.GetDefaultEncoding().GetString(this.Body.ToArray());
		}
		public string ToBodyString()
		{
			return Phoenix.GetDefaultEncoding().GetString(this.Body.ToArray());
		}
		public void Clear()
		{
			this.Body.Clear();
		...
		{
			this.AppendString(s, Phoenix.GetDefaultEncoding());
		}
